...
func main() {
	...
	fmt.Println("Please select option.\n" +
		...
		"7. [OFFLINE] Export encrypted mnemonic file - Please use this option exclusively in offline mode to encrypt and export your 12/24 word mnemonic seed phrase\n" +
		// need to verify text here
		"8. [OFFLINE] Verify the recovery package using HSM token\n" +
		// need to verify text here
		"9. Export HSM public key - Info here",
	)
